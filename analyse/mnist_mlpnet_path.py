...
#TODO: rewrite for mlpnet
def baseline():
    EXP_DIR=RESULT_ROOT
    EXP_NAME = 'sweep_mnist_mlpnet_woodfisher'
    WFB_DIR  = os.path.join(EXP_DIR, EXP_NAME)

    EXP_NAME = 'sweep_mnist_mlpnet_woodfisher_no_weight_update'
...
def target_greedyonline_init_mag():
    EXP_DIR=RESULT_ROOT
    EXP_NAME='mnist-mlpnet-backbone_layers-fullfisher_fisher-greedy_online_mag_all_layers'
    NOWDATE='results.train_loss_all_samples.20220112.03_57_26'
    ARCH_NAME="mlpnet_mnist_10000samples_10000batches_%dseed"
...
def target_greedyonline_init_magperb():
    EXP_DIR=RESULT_ROOT
    EXP_NAME='mnist-mlpnet-backbone_layers-fullfisher_fisher-greedy_online_magperb_all_layers'
    NOWDATE='results.train_loss_all_samples.20220112.03_57_26'
    ARCH_NAME="mlpnet_mnist_10000samples_10000batches_%dseed"
    GREEDY_DIR=f"{EXP_DIR}/{EXP_NAME}/{NOWDATE}/{ARCH_NAME}"    
...
def read_baseline():
    path = './prob_regressor_results/mnist_mag_baseline.txt'
