...
#bluefish_ROOT=/uusoc/scratch/bluefish/jcao/echo-bf/comb_prune
#ROOT_DIR=${bluefish_ROOT}
ROOT_DIR=./
...
ARCH_NAME="seed${SEED}_batchsize${BSZ}"
...
--workers=20 --batch_size=${BSZ} --logging_level debug \
