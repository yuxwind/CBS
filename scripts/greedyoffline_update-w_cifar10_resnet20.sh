...
EXP_NAME="greedy_offline-cifar10-resnet20_no_allweights"
...
WEIGTH_DIR=$ROOT_DIR/prob_regressor_data/
...
IDX_2_MODULE_PATH=$WEIGTH_DIR/resnet20_cifar10_1000samples_1000batches_0seed-idx_2_module.npy
...
python ${ROOT_DIR}/main.py $args $greedy_args &> $LOG_PATH 2>&1
