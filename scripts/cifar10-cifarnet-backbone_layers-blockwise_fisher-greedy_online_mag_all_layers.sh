...
ARCH_NAME=cifarnet_cifar10_1000samples_1000batches_${SEED}seed
WGH_PATH=$WEIGHT_DIR/cifarnet_cifar10_1000samples_1000batches_${SEED}seed.pkl
IDX_2_MODULE_PATH=$WEIGHT_DIR/cifarnet_cifar10_1000samples_1000batches_${SEED}seed-idx_2_module.npy
